...
export const userUpdateSchema = z.object({
  first_name: z.string().trim().min(1, 'first_name é obrigatório').optional(),
  last_name: z.string().trim().min(1, 'last_name é obrigatório').optional(),
  email: z.string().trim().min(1, 'email é obrigatório').email('Email inválido').optional(),

  password: z.string().trim().min(6, 'Senha deve ter no mínimo 6 caracteres').optional(),
